...
sunMaterial.map = new THREE.TextureLoader().load('sunmapthumb.jpg');
scene.add(sun);
...
merMaterial.map = new THREE.TextureLoader().load('mercurymapthumb.jpg');
merMaterial.bumpMap = new THREE.TextureLoader().load('mercurybumpthumb.jpg');
...
venusMaterial.map = new THREE.TextureLoader().load('venusmapthumb.jpg');
venusMaterial.bumpMap = new THREE.TextureLoader().load('venusbumpthumb.jpg');
...
earthMaterial.map = new THREE.TextureLoader().load('earthmap.jpg');
earthMaterial.bumpMap = new THREE.TextureLoader().load('earthbump.jpg');
earthMaterial.bumpScale = 0.05;
earthMaterial.specularMap = new THREE.TextureLoader().load('earthspec.jpg');
...
moonMat.map = new THREE.TextureLoader().load('moonmap1k.jpg');
scene.add(moon);
...
marsMaterial.map = new THREE.TextureLoader().load('marsmapthumb.jpg');
marsMaterial.bumpMap = new THREE.TextureLoader().load('marsbumpthumb.jpg');
...
jupMaterial.map = new THREE.TextureLoader().load('jupitermapthumb.jpg');
scene.add(jupiter);
...
satMaterial.map = new THREE.TextureLoader().load('saturnmapthumb.jpg');
scene.add(saturn);
saturn.position.set(-1700, 0, 0);

var satRing = new THREE.RingGeometry (85,100,35);
var texture1 = new THREE.TextureLoader().load("saturnringcolorthumb.jpg");
...
uranusMaterial.map = new THREE.TextureLoader().load('uranusmapthumb.jpg');
scene.add(uranus);
uranus.position.set(-2000, 0, 0);

var uraRing= new THREE.RingGeometry (80,100,35);
var texture2 = new THREE.TextureLoader().load("saturnringcolorthumb.jpg");
var texture3 = new THREE.TextureLoader().load("uranusringcolor.jpg");
...
nepMaterial.map = new THREE.TextureLoader().load('neptunemapthumb.jpg');
scene.add(neptune);
